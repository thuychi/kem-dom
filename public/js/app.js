...
},{"../view/account/login":5,"../view/account/register":6,"kem/dom":8}],2:[function(require,module,exports){
var { DOM } = require('kem/dom');
...
},{"../view/index/index.js":7,"kem/dom":8}],3:[function(require,module,exports){
require('./phone').pushState = false;
},{"./phone":4}],4:[function(require,module,exports){
require('kem/dom/prototype');

var { cookie, app } = require('kem/dom');

app.use(function (next) {
	if (!cookie.has('user')) next();else console.log('disabled');
});
...
module.exports = app;
},{"./controller/account":1,"./controller/index":2,"kem/dom":8,"kem/dom/prototype":18}],5:[function(require,module,exports){
...
},{"kem/dom":8}],6:[function(require,module,exports){
var { DOM, Link } = require('kem/dom');
...
},{"kem/dom":8}],7:[function(require,module,exports){
var { DOM, Link } = require('kem/dom');
...
},{"kem/dom":8}],8:[function(require,module,exports){
...
},{"../lib/async.js":19,"../lib/cache/index.js":20,"../lib/check.js":22,"../lib/cookie/index.js":23,"../lib/event":24,"../lib/is.js":25,"../lib/socket.js":26,"./lib/dom.js":11,"./plugin/link.js":15,"./plugin/modal.js":16,"./plugin/router.js":17}],9:[function(require,module,exports){
...
},{"./state-node":14}],10:[function(require,module,exports){
...
},{"../../lib/event.js":24,"./append-child.js":9,"./attribute.js":10,"./state-element.js":12}],12:[function(require,module,exports){
...
},{"./state-event":13}],13:[function(require,module,exports){
class ArrayAction {
	constructor() {
...
},{"../lib/dom.js":11,"./router.js":17}],16:[function(require,module,exports){
...
},{"../lib/dom.js":11}],17:[function(require,module,exports){
var DOM = require('../lib/dom.js'),
...
var App = module.exports = {
	...
	use: function(uri, fn, action){
		('string' === typeof uri) 
		? this.routes.push({ uri: new RegExp('^' + uri + '$'), fn, action }) 
		: this.routes.push({ fn: uri });
	},
	handle: function(){
...
},{"../../lib/async.js":19,"../lib/dom.js":11}],18:[function(require,module,exports){
/**
 *	Array Prototype
 */
...
},{"./server":21}],21:[function(require,module,exports){
var cache = {
	_set: {},
	_hset: {}
};
...
},{"./trim":27}],23:[function(require,module,exports){
var Cookie = {
	define: '',
	data: {},
...
},{"./check":22}],26:[function(require,module,exports){
/**
